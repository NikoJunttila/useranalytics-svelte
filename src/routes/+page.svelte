...
<div id="blur" on:mousemove={handleMousemove} class="z-10 overflow-hidden">
  <section class="w-full h-screen flex flex-col items-center justify-center">
    <main id="card"
      class="w-64 md:w-80 grid place-items-center z-0 relative p-1 bg-base-200 shadow  overflow-hidden rounded"
    >
    <div class="grid place-items-center bg-base-200 p-2 z-10">
